...
const DoughnutChart = ({
  ...
  //**nice this is bulb icon rendering */
  ...
  return (
    <>
      <div className={` mb-2 box-main ${mode || 'light-mode'}`}>
        <div className="container w-100 h-100 d-flex justify-content-center position-relative">
          <div
            ...
            >
              <div
                ...
                className={`layout-transition ${
                  (showThreeColumn && 'donut-three-col-dimension') ||
                  (showFourColumn && 'donut-four-col-dimension') ||
                  'donut-dimension'
                }  `}
              >
        ...
        {showfullchart && (
          <ChartFull show={show} setShow={setShow} Chart={DoughnutChart} />
        )}
      </div>
