  ...
  return (
    <>
      <div className={` mb-2 box-main ${mode || "light-mode"}`}>
        <div
          className={`container d-flex justify-content-center position-relative main-chart-container `}
        >
          <div
        ...
        {show && (
          <ChartFull show={show} setShow={setShow} Chart={HorizontalChart} />
        )}
      </div>
